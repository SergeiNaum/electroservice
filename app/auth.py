from flask import Blueprint, get_flashed_messages, redirect, url_for, render_template, flash
...
def reg():
    ...
    return render_template('authTemplates/registration.html',
                           data=data, form=form, action='Register')
...
def login():
    ...
    return render_template('authTemplates/login.html', data=data, form=form, action='Login')
