...
class ExpenseForm(FlaskForm):
    title = StringField(
        "Название",
        validators=[DataRequired()],
        render_kw={"placeholder": "Введите название расхода"},
    )
    description = TextAreaField(
        "Описание", render_kw={"placeholder": "Введите описание"}
    )
    price = DecimalField("Цена", render_kw={"placeholder": "Введите цену"})
